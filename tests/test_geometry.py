...
def test_get_curvature():
    radius1 = 10.0
    curvature1 = geom.get_curvature(geom.get_circle(0.0, 0.0, radius1, 100))
    ...
    curvature2 = geom.get_curvature(geom.get_circle(0.0, 0.0, radius1, 200))
    ...
    radius2 = 20.0
    curvature3 = geom.get_curvature(geom.get_circle(0.0, 0.0, radius2, 1000))
    ...
    curvature4 = geom.get_curvature(geom.get_circle(0.0, 0.0, radius2, 1000), w=7, po=2)
...
def test_get_convex_curve_square():
    ...
    radius1 = 10.0
    assert geom.get_convex_curve_square(geom.get_circle(0.0, 0.0, radius1, 200)) == approx(np.pi * radius1 * radius1, rel=0.001)
